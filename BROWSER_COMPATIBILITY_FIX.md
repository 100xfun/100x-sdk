...
- **CJS版本** (`dist/100x-sdk.cjs.js`): 1.5MB (Node.js 专用)
- **ESM版本** (`dist/100x-sdk.esm.js`): 1.4MB (现代浏览器/构建工具)
- **UMD版本** (`dist/100x-sdk.js`): 1.4MB (浏览器直接使用)
...
<script src="dist/100x-sdk.js"></script>

<script>
const connection = new solanaWeb3.Connection('https://api.devnet.solana.com');
const sdk = new SpinSDK.Fun100xSdk(connection, 'programId', options);
</script>
```
...
修复完成！100x SDK 现在可以在 Node.js 和浏览器环境中无缝运行。